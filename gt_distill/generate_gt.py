...
if __name__ == '__main__':
    ...
    parser.add_argument("--recordings_basedir", type=dir_path, default="train/datasets", help="path to base directory with recordings")
    parser.add_argument("--openpilot_dir", type=dir_path, default=str(Path.home() / 'Documents/SourceCode/openpilot'), help="path to openpilot directory")
